...
- **2026.7** Our recent paper on KAN-based semantic segmentation for remote sensing images has been accepted by *IEEE Trans. on Geoscience and Remote Sensing* (IF 9.4).
...
- **2026.5** **关于香港中文大学（深圳）-觅熵遥感技术联合实验室停止合作的声明 (2026.5.9)：** 鉴于双方合作基础及后续发展方向的变化，经审慎考虑与友好协商，香港中文大学（深圳）与觅熵科技共同决定，自本声明发布之日起，正式终止“香港中文大学（深圳）-觅熵遥感技术联合实验室”的合作关系。该联合实验室即日起取消。 **Statement on the Termination of Cooperation of the CUHKSZ–MizarVision Remote Sensing Technology Joint Laboratory (2026.5.9):** In light of changes to the basis of cooperation and subsequent development directions between the two parties, and following careful consideration and friendly consultations, The Chinese University of Hong Kong, Shenzhen and MizarVision Technology have jointly decided to formally terminate the cooperation of the "CUHKSZ – MizarVision Remote Sensing Technology Joint Laboratory" effective from the date of issuance of this statement.The Joint Laboratory is hereby cancelled with immediate effect.
...
- **2026.3** Our recent paper on integrating Reinforcement Learning and Large Language Model for Traffic Signal Control has been accepted by the *IEEE Trans. on Vehicular Technology (TVT)* (IF 7.1).  [[Paper Link]](https://ieeexplore.ieee.org/document/11434951)
- **2026.2** Our recent paper on Semantic Speech Communication has been accepted by the *IEEE Trans. on Vehicular Technology (TVT)* (IF 7.1). [[Paper Link]](https://ieeexplore.ieee.org/document/11415303)
